...
export const SortingProvider = ({ children }: { children: ReactNode }) => {
   ...
   *
   * @remarks
   * This function generates a new array of random numbers based on the width of the content container.
   * It sets the new array as the array to be sorted, and resets the sorting and animation flags.
   * It also clears any existing intervals and resets the line colors to their default state.
   */
  ...
  /**
   * Runs the animation for sorting algorithm.
   *
   * @param animations - An array of animations representing the sorting process.
   */
